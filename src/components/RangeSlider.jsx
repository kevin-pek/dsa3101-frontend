...
class RangeSlider extends PureComponent {
  ...
  setValue(newValue, forceSet = false, callback = true) {
    ...
    this.input[this.index.max].current.value =
      this.thumbDrag || forceSet ? newValue.max : newValue.min + this.rangeWidth
    this.syncValues()
  ...
  // DISABLED THIS SO THAT CLICKING ON THE ELEMENT DOES NOT SET THE RANGE
  // ONLY WAY TO SET THE RANGE IS TO DRAG THE SLIDER
    ...
    return (
      ...
      >
        ...
        <div
          ...
          onMouseEnter={this.props.onMouseEnterRange}
        >
          {this.props.children}
        </div>
      </div>
